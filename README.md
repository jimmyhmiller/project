...
The human-readable source of truth is `projects.kdl`. Dashboard decisions are also cached as JSON so the browser and Rust tool can exchange structured data without lossy KDL edits.
